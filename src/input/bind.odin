...
COMMANDS := [Command]Command_Info {
    ...
    .Save                = {"file.dump", "write the focused document into oket's state directory, whatever opened it", {.Text, .Surface}},
    ...
    .Ring_Close          = {"ring.close", "close the focused slot and the panel with it; its number is never reused while others live", {.Global}},
